...
import com.hui.huiapicommon.model.enums.InterfaceInfoStatusEnum;
...
public class InterfaceInfoController {
    ...
    public BaseResponse<Boolean> onlineInterfaceInfo(@RequestBody IdRequest idRequest,
        ...
        // 判断该接口是否可以调用
        com.hui.huiapiclientsdk.model.User user = new com.hui.huiapiclientsdk.model.User();
    ...
    public BaseResponse<Object> invokeInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest,
        ...
        Gson gson = new Gson();
        com.hui.huiapiclientsdk.model.User user = gson.fromJson(userRequestParams, com.hui.huiapiclientsdk.model.User.class);
